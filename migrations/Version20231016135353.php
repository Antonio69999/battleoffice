 ...
 */
final class Version20231016135353 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, biling_adress_id INT DEFAULT NULL, shipping_adress_id INT DEFAULT NULL, payment_id INT DEFAULT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_F529939819EB6921 (client_id), INDEX IDX_F5299398DB4473E5 (biling_adress_id), INDEX IDX_F5299398C273A89B (shipping_adress_id), INDEX IDX_F52993984C3A3BB (payment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
